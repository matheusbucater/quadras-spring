...
public class UsuarioIsNotProfessorAdvice {

    @ExceptionHandler(UsuarioIsNotProfessorException.class)
    public ResponseEntity<ErrorMessageDTO> usuarioIsNotProfessor(UsuarioIsNotProfessorException ex) {
