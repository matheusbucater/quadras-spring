...
public class UsuarioNotVerifiedAdvice {

    @ExceptionHandler(UsuarioNotVerifiedException.class)
    public ResponseEntity<ErrorMessageDTO> usuarioNotVerifiedException(UsuarioNotVerifiedException ex) {
